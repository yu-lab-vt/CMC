...
#'
#' @details The formats of the input file is ".txt", ".tab" or ".csv". Row names are gene names, and column names are cell IDs.\cr
#'          For example:\cr
...
#'
#' @param Input_str Input_str is the input ".txt" file including its path (Like this: "./Similarity_analysis/scRNA_seq_Data.txt").\cr
